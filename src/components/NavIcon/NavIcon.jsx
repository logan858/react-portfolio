...
export default function NavIcon(props) {
    ...
    const navChooser = () => {
        if (props.iconStyle === 'white' && props.theme === 'Light') {
            props.newColor(props.accentColor)
    ...
    return (
        <div 
            className="nav-icon"
            style={props.theme === "Dark" ? {borderBottom: 'rgba(47, 47, 47, 0.3) dashed 1px' } : {borderBottom: 'rgba(27, 27, 27, 0.1) dashed 1px' }}
        >
            <motion.div 
            ...
            > 
                <svg 
                    height="32px" 
                    style={{fill: `${navChooser()}`}}
                    onClick={() => iconColor()}
                    className="icon-svg"
                > 
                    <path d="M9.8,25c0,0,0.8-1.8,0.9-2.3c0.1-0.5-6.8-5.7-6.8-5.7s1.7-0.5,1.8-0.9C5.8,15.8,4.3,12,4.3,12s3.6,0.9,4,0.7
