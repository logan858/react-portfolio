...
export default function ThemeButton(props) {
    const handleTheme = () => {
        if(props.theme === "Dark") {
            ...
            props.setColor({color: "rgba(255, 255, 255, 0.4)"})
            props.setAccentColor({accentColor: "rgba(47, 47, 47, 0.9)"})
        } else {
            props.setTheme({theme: "Dark"})
            props.setColor({color: "rgba(47, 47, 47, 0.4)"})
    ...
    return (
        <div>
            <div onClick={() => handleTheme()} id="theme" style={{backgroundColor: props.color}}>
                ...
                >
                    <path d="M10.7,19.3c-0.3,0-0.5-0.2-0.6-0.4l-0.5-1.9c-0.9-0.1-1.8-0.3-2.6-0.7l-1.4,1.4c-0.2,0.2-0.6,0.2-0.8,0
